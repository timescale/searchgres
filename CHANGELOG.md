...
- Restore cross-platform reference-binary publishing by invoking the pinned Bun
  executable directly, and verify that unpinned installer runs resolve the
  latest GitHub release tag before downloading assets.
